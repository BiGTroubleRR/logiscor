...
export const cs: Dict = {
  header: {
    ...
    loading: 'načítání…',
    countOfCarriers: (filtered, total) => `${filtered} z ${total} dopravců`,
    countOfManufacturers: (filtered, total) => `${filtered} z ${total} výrobců`,
    totalCarriers: (n) => `${n} dopravců`,
    totalManufacturers: (n) => `${n} výrobců`,
  ...
  filterBar: {
    ...
    manufacturersOnly: (n) => `Pouze výrobci (${n})`,
    hasQuoteOnly: (n) => `Má nabídku na tuto trasu (${n})`,
    clearFilters: 'Vymazat filtry',
    advancedFilters: 'Pokročilé filtry ▾',
    hideAdvancedFilters: 'Pokročilé filtry ▴',
    allNdaStatus: 'Jakýkoli stav NDA',
    ndaReceivedOption: 'NDA obdržena',
    ndaNotReceivedOption: 'NDA neobdržena',
    allStrengthTiers: 'Jakákoli síla',
    allEmailQuality: 'Jakákoli kvalita e-mailu',
    allRowColors: 'Jakákoli barva',
    addressImpreciseOnly: 'Pouze nepřesná adresa',
  ...
  table: {
    ...
    addressNotPreciseHint: 'Chybí město — poloha může být jen hrubý odhad podle země.',
  ...
  drawer: {
    ...
    tabRates: 'Sazby',
    tabNda: 'NDA',
    tabOther: 'Další údaje',
    ndaReceivedLabel: 'NDA obdržena',
    ndaReceivedDateLabel: 'Datum obdržení',
    ndaNotesLabel: 'Poznámky',
    ndaNotesPlaceholder: 'Verze NDA, kdo podepsal, odkaz na soubor...',
    ndaReceivedHint: 'NDA obdržena',
